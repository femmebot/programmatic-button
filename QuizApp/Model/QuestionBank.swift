...
class QuestionBank {
    ...
    init(){
        ...
        // let q = Question(text: String, correctAnswer: Bool)
        ...
        list.append(Question(text: "Japan will be hosting the Olympic games in 2020 for the fourth time.", correctAnswer: true))
